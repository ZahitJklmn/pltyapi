...
const allInteriorProducts = [
    {
        ...
        link: "/urunler/bianca/diger-urunler/bianca-stella-mermer-efekt-spreyi",
        description:
          "Kağıt, karton, ahşap, cam, metal, seramik, porselen, taş gibi farklı yüzeylerde kullanılabilir. ",
        image: "/bianca/mermer-sprey.png?height=300&width=300&text=",
    },
]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative h-[300px] md:h-[400px] rounded-lg overflow-hidden mb-12">
          <div
            ...
            style={{ backgroundImage: "url('/stock/ozel-efekt.jpg?height=400&width=1200&text=İç Cephe Ürünleri')" }}
          ></div>
          <div className="absolute inset-0 bg-black/50"></div>
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white">Özel Efekt Boyaları</h1>
          </div>
        </div>
